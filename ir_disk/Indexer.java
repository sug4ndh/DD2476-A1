...
public class Indexer {
    ...
    private File docList = new File("/home/sugandh/Downloads/ir-assignments/doclist.txt");
	...
	// do not try to index fs that cannot be read
        ...
        if (!new File("/home/sugandh/Downloads/ir-assignments/terms").isFile()){
            try {

                //System.out.println("Creating terms directory");
                Files.createDirectory(Paths.get("terms"));
	...
	if ( f.canRead() ) {
		...
		//index.docIDs.put( "" + docID, f.getPath() );
                    FileWriter  fr = new FileWriter (docList, true);
                    fr.write( docID + " " + f.getPath() + "\n");
                    fr.close();
    ...
    /*public void insertIntoIndex( int docID, String token, int offset ) {
            ...
            System.out.println("Creating Document list and indexing...Wait!"); 
	...
	System.out.println("calling loaddocnamesindexer");
	index.loadnames();
    }
}
